...
int main() {
  ...
  cout << "Please endter the start date, format is yyyy-mm-dd: ";
  cin >> startDate;
  cout << "Please endter the start time, format is hh-mm-ss (24 hours): ";
  cin  >> startTime;
  // End date and time
  string endDate, endTime;
  cout << "Please endter the end date, format is yyyy-mm-dd: ";
  cin >> endDate;
