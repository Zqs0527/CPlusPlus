...
public:
	DarkGreenText(HANDLE hConsole)
	{
		...
		_theme = "light";
		cout << "Making the dark green" << endl;
	}
	void message(HANDLE hConsole)
	{
		SetConsoleTextAttribute(hConsole, 242);
		cout << "This is dark green font for the light theme" << endl;
	}
};
...
public:
	LightGreenText(HANDLE hConsole)
	{
		...
		_theme = "dark";
		cout << "Making the light green" << endl;
	}
	void message(HANDLE hConsole)
	{
		SetConsoleTextAttribute(hConsole, 10);
		cout << "This is light green font for the dark theme" << endl;
	}
};
